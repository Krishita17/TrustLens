...
TrustLens solves this by generating real-time, human-readable explanations for every single authentication decision.
...
Run all commands from the `trustlens/` directory:
```bash
cd trustlens
python -m src.models.train
```
