# TrustLens Threat Model

This document is a **STRIDE** threat model for the TrustLens authentication engine
and — crucially — for the **explainability layer** that sits on top of it. Most
threat models stop at the classifier; because TrustLens puts explanations in front
...
| # | STRIDE | Threat | Asset at risk | Mitigation in TrustLens |
|---|--------|--------|---------------|-----------------------|
...
Residual risk is documented rather than hidden: TrustLens's contribution is to
